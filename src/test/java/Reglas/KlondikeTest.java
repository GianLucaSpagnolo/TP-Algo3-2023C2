...
public class KlondikeTest {
    ...
    public void klondikeSemillaVacia() {
        ...
        Columna seleccion1 = klondike.seleccionarCartas(1, 3);
        assertNull(seleccion1);
        assertFalse(klondike.moverCartas(seleccion1, 1, 0));
        Columna seleccion2 = klondike.seleccionarCartas(6, 0);
        assertNull(seleccion2);
        assertFalse(klondike.moverCartaColumnaFinal(seleccion2, 6, 0));
    ...
    public void moverUnaCartaEntreColumnas() {
        ...
        Columna seleccion1 = klondike.seleccionarCartas(0, 0);
        assertNotNull(seleccion1);
        assertFalse(klondike.moverCartas(seleccion1, 0, 5));
        Mesa mesa1 = klondike.getEstadoMesa();
        ...
        Columna seleccion2 = klondike.seleccionarCartas(3, 0);
        assertNotNull(seleccion2);
        assertFalse(klondike.moverCartas(seleccion2, 3, 0));
        Mesa mesa2 = klondike.getEstadoMesa();
        ...
        Columna seleccion3 = klondike.seleccionarCartas(3, 0);
        assertNotNull(seleccion3);
        assertTrue(klondike.moverCartas(seleccion3, 3, 2));
        Mesa mesa3 = klondike.getEstadoMesa();
        ...
        Columna seleccion4 = klondike.seleccionarCartas(0, 0);
        assertNotNull(seleccion4);
        assertTrue(klondike.moverCartas(seleccion4, 0, 3));
        ...
        Columna seleccion5 = klondike.seleccionarCartas(0, 0);
        assertNull(seleccion5);
        assertFalse(klondike.moverCartas(seleccion5, 0, 6));
    ...
    public void testMoverCartaDescarteAColumnaMesa() {
        ...
        mesa5.insertarCartaDescarte(carta5);
        ...
        mesa6.insertarCartaDescarte(carta6);
        ...
        mesa7.insertarCartaDescarte(carta7);

        klondike.moverCartaColumnaFinal(klondike.seleccionarCartas(4, 0), 4, 1);
        assertTrue(klondike.moverCartaDescarteAColumnaMesa(4));
        Mesa mesa8 = klondike.getEstadoMesa();
        Carta carta8 = mesa8.sacarCartaDescarte();
        assertNotNull(carta8);
        ...
        mesa8.insertarCartaDescarte(carta8);
    ...
    public void testMoverCartaColumnaFinal() {
        ...
        assertFalse(klondike.moverCartaColumnaFinal(klondike.seleccionarCartas(2, 0), 2, 1));
        Mesa mesa1 = klondike.getEstadoMesa();
        ...
        assertFalse(klondike.moverCartaColumnaFinal(klondike.seleccionarCartas(5, 0), 5, 2));
        Mesa mesa2 = klondike.getEstadoMesa();
        ...
        for (int i = 0; i < 14; i++)
            klondike.sacarDelMazo();
        klondike.moverCartaDescarteAColumnaFinal(3);
        assertTrue(klondike.moverCartaColumnaFinal(klondike.seleccionarCartas(2, 0), 2, 3));
        Mesa mesa4 = klondike.getEstadoMesa();
        ...
        assertFalse(klondike.moverCartaColumnaFinal(klondike.seleccionarCartas(1, 0), 1, 0));
        Mesa mesa5 = klondike.getEstadoMesa();
        ...
        assertFalse(klondike.moverCartaColumnaFinal(klondike.seleccionarCartas(0, 0), 0, 3));
        Mesa mesa6 = klondike.getEstadoMesa();
        ...
        assertFalse(klondike.moverCartaColumnaFinal(klondike.seleccionarCartas(2, 0), 2, 3));
        Mesa mesa7 = klondike.getEstadoMesa();
        ...
        assertFalse(klondike.moverCartaColumnaFinal(klondike.seleccionarCartas(6, 0), 6, 3));
        Mesa mesa8 = klondike.getEstadoMesa();
    ...
    public void moverVariasCartasEntreColumnas() {
        ...
        assertTrue(klondike.moverCartas(klondike.seleccionarCartas(3, 0), 3, 2));
        assertTrue(klondike.moverCartas(klondike.seleccionarCartas(0, 0), 0, 3));
        for (int i = 0; i < 3; i++)
            klondike.sacarDelMazo();
        assertTrue(klondike.moverCartaDescarteAColumnaMesa(1));
        klondike.sacarDelMazo();
        ...
        klondike.sacarDelMazo();
        assertTrue(klondike.moverCartaDescarteAColumnaMesa(2));
        assertTrue(klondike.moverCartas(klondike.seleccionarCartas(4, 0), 4, 2));
        klondike.sacarDelMazo();
        assertTrue(klondike.moverCartaDescarteAColumnaMesa(4));

        assertFalse(klondike.moverCartas(klondike.seleccionarCartas(3, 0), 3, 0));
        ...
        assertFalse(klondike.moverCartas(klondike.seleccionarCartas(1, 1), 1, 5));
        Mesa mesa2 = klondike.getEstadoMesa();
        ...
        assertFalse(klondike.moverCartas(klondike.seleccionarCartas(5, 1), 5, 4));
        Mesa mesa3 = klondike.getEstadoMesa();
        ...
        assertFalse(klondike.moverCartas(klondike.seleccionarCartas(1, 1), 1, 6));
        Mesa mesa4 = klondike.getEstadoMesa();
        ...
        assertTrue(klondike.moverCartas(klondike.seleccionarCartas(2, 3), 2, 4));
        Mesa mesa5 = klondike.getEstadoMesa();
        ...
        assertTrue(klondike.moverCartas(klondike.seleccionarCartas(4, 5), 4, 1));
        Mesa mesa6 = klondike.getEstadoMesa();
        ...
        assertTrue(klondike.moverCartas(klondike.seleccionarCartas(1, 7), 1, 4));
        Mesa mesa7 = klondike.getEstadoMesa();
        ...
        assertTrue(klondike.moverCartas(klondike.seleccionarCartas(1, 0), 1, 0));
        for (int i = 0; i < 6; i++)
            klondike.sacarDelMazo();
        assertTrue(klondike.moverCartaDescarteAColumnaMesa(1));
        for (int i = 0; i < 4; i++)
            klondike.sacarDelMazo();
        assertTrue(klondike.moverCartaDescarteAColumnaMesa(5));
        assertTrue(klondike.moverCartas(klondike.seleccionarCartas(5, 2), 5, 0));
        Mesa mesa8 = klondike.getEstadoMesa();
        ...
        Columna seleccion = klondike.seleccionarCartas(4, 8);
        assertNotNull(seleccion);
        assertTrue(klondike.moverCartas(seleccion, 4, 0));
        Mesa mesa9 = klondike.getEstadoMesa();
        ...
        assertTrue(klondike.moverCartas(klondike.seleccionarCartas(0, 3), 0, 5));
        ...
        assertFalse(klondike.moverCartas(klondike.seleccionarCartas(0, 3), 0, 6));
    ...
    public void verificarJuegoGanado() {
        ...
        for (int i = 0; i < 7; i++) {
            for (int j = i; j < 7 ; j++) {
                ...
                klondike.moverCartaColumnaFinal(klondike.seleccionarCartas(j, 0), j, contadorFinal);
                contadorFinal++;
                if (contadorFinal > 3)
                    contadorFinal = 0;
            }
    ...
    public void manipulacionDeEstadosParticularesDeMesa() {
        ...
        klondike1.moverCartas(klondike1.seleccionarCartas(3, 0), 3, 2);
        klondike1.moverCartaColumnaFinal(klondike1.seleccionarCartas(4, 0), 4, 1);
        for (int i = 0; i < 3; i++) {
        ...
        klondike3.moverCartas(klondike3.seleccionarCartas(4, 0), 4, 1);
        klondike3.sacarDelMazo();
        klondike3.moverCartaDescarteAColumnaMesa(1);
        klondike3.moverCartas(klondike3.seleccionarCartas(2, 1), 2, 1);
        klondike3.moverCartaDescarteAColumnaMesa(1);
